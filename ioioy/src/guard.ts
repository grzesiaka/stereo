...
// export type Guard<Ctx extends CtxIdConstraint = __, X = unknown, IX = X, Params = __> = IO<IX, X, X, Ctx, IX> &
//   WithOP<"GR", Params> & { OO: Set<Cb<X>> };

// export type IdGuard = Guard<any, any> & { O: { Id: string } };
// export type IdGuards = ARR<IdGuard>;
