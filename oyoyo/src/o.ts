...
export type ComposeAsync<X, L, cR> = (() => X) &
  ...
  (<const R extends cR | Promise<cR>, const X0, const X1>(
    f0: (x: $$<X>, L: L) => X0,
    f1: (x: A<X0>, L: L, R: AA<[$$<X>, X0]>) => X1,
    f2: (x: A<X1>, L: L, R: AA<[$$<X>, X0, X1]>) => R,
  ) => (...x: FLIP<X>) => oResult<[$$<X>, X0, X1, R]>) &
  (<const R extends cR | Promise<cR>, const X0, const X1, const X2>(
    f0: (x: $$<X>, L: L) => X0,
    f1: (x: A<X0>, L: L, R: AA<[$$<X>, X0]>) => X1,
    f2: (x: A<X1>, L: L, R: AA<[$$<X>, X0, X1]>) => X2,
    f3: (x: A<X2>, L: L, R: AA<[$$<X>, X0, X1, X]>) => R,
  ) => (...x: FLIP<X>) => oResult<[$$<X>, X0, X1, X2, R]>) &
  (<const R extends cR | Promise<cR>, const X0, const X1, const X2, const X3>(
    f0: (x: $$<X>, L: L) => X0,
    f1: (x: A<X0>, L: L, R: AA<[$$<X>, X0]>) => X1,
    f2: (x: A<X1>, L: L, R: AA<[$$<X>, X0, X1]>) => X2,
  ...
  (<const R extends cR | Promise<cR>, const X0, const X1, const X2, const X3, const X4>(
    f0: (x: $$<X>, L: L) => X0,
    f1: (x: A<X0>, L: L, R: AA<[$$<X>, X0]>) => X1,
    f2: (x: A<X1>, L: L, R: AA<[$$<X>, X0, X1]>) => X2,
    f3: (x: A<X2>, L: L, R: AA<[$$<X>, X0, X1, X]>) => X3,
  ...
  (<const R extends cR | Promise<cR>, const X0, const X1, const X2, const X3, const X4, const X5>(
    f0: (x: $$<X>, L: L) => X0,
    f1: (x: A<X0>, L: L, R: AA<[$$<X>, X0]>) => X1,
    f2: (x: A<X1>, L: L, R: AA<[$$<X>, X0, X1]>) => X2,
    f3: (x: A<X2>, L: L, R: AA<[$$<X>, X0, X1, X]>) => X3,
  ...
  (<const R extends cR | Promise<cR>, const X0, const X1, const X2, const X3, const X4, const X5, const X6>(
    f0: (x: $$<X>, L: L) => X0,
    f1: (x: A<X0>, L: L, R: AA<[$$<X>, X0]>) => X1,
    f2: (x: A<X1>, L: L, R: AA<[$$<X>, X0, X1]>) => X2,
    f3: (x: A<X2>, L: L, R: AA<[$$<X>, X0, X1, X]>) => X3,
